...
def fitfun_thru(x, r1, r2a, lam, FWHM):
    # Ring thru port based on physical parameters
    retval = (r1**2+r2a**2-2*r1*r2a*cos(FWHM*(1/x-1/lam)))/(1+r1**2*r2a**2-2*r1*r2a*cos(FWHM*(1/x-1/lam)))
    return retval

def fitfun_drop(x, A, r1r2a, lam, FWHM):
    # Ring drop port based on physical parameters
    retval = 1-A/(1+r1r2a**2-2*r1r2a*cos(FWHM*(1/x-1/lam)))
    return retval